...
export function filterDestinations(
  ...
  return destinations.filter((d) => {
    ...
    if (filters.budgetCategory && d.budgetCategory !== filters.budgetCategory) {
      return false;
    }
...
export function filtersToSearchParams(
  ...
  if (filters.budgetCategory) params.set("budget", filters.budgetCategory);
...
export function searchParamsToFilters(params: URLSearchParams): {
  ...
  return {
    ...
    filters: {
      ...
      budgetCategory: params.get("budget") ?? "",
...
export function getActiveFilterCount(filters: FilterState): number {
  ...
  if (filters.budgetCategory) count++;
